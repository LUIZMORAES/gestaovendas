        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Alterar de Pedido de venda| Voltar: <a
                            href="{{ route('Comercial.Venda.listarMpdv') }}" class="btn btn-success "><i
                                class="fas fa-arrow-alt-circle-left"></i></a></h3>
                </div>
            </div>
            <!-- Form 1-->
            <form role="form" method="post" action="{{ route('Comercial.Venda.updateMpdv') }}">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Form 2-->
                                            <form method="post"
                                                action="{{route('Comercial.Venda.buscarEcliente2',$mclientes->id)}}">
                                                @csrf
                                                <input type="hidden" readonly class="form-control" name="id_pedido"
                                                    value="{{ isset($id_pedido) ? $id_pedido : null }}">
                                                <input type="hidden" name="id_cliente" value="{{$mclientes->id}}">
