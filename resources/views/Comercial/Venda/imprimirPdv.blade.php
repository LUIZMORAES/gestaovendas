                ...
                <section class="invoice">
                    ...
                    <div class="row invoice-info">
                        <div class="col-sm-6 invoice-col">
                            <b>Cliente : {{$mpedidoVenda->id}} - {{$mpedidoVenda->razaoSocial}}</b><br>
                            <b>Nome Fantasia : {{$mpedidoVenda->nomeFantasia}}</b><br>
                            <b>CPF / CNPJ :</b> {{$mpedidoVenda->cpfcnpj}}<br>
                            <b>Inscrição Estadual :</b> {{$mpedidoVenda->insestadual}}<br>
                            <b>Inscrição Municipal :</b> {{$mpedidoVenda->insmunicipal}}<br>
                            <b>Endereço : Cep </b>{{$mpedidoVenda->end_cep}} - {{$mpedidoVenda->end_logradouro}},
                            {{$mpedidoVenda->end_numero}} -
                            {{$mpedidoVenda->end_complemento}}<br>
                            <b>Bairro :</b> {{$mpedidoVenda->end_bairro}} - {{$mpedidoVenda->end_cidade}} -
                            {{$mpedidoVenda->end_uf}}
                        </div>
                        <br>
                        <div class="col-sm-6 invoice-col">
