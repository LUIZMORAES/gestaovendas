                ...
                <section class="invoice">
                    ...
                    <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col">
                            <b>Fonecedor : {{$mpedidoCompra->id}} - {{$mpedidoCompra->nomeFantasia}}</b><br>
                            <b>CPF / CNPJ :</b> {{$mpedidoCompra->cpfcnpj}}<br>
                        </div>
                        <div class="col-sm-4 invoice-col">
                            <b>NÚMERO PEDIDO #000{{$mpedidoCompra->id}}</b><br>
                            <b>Emissão:</b> {{date('d/m/Y', strtotime($mpedidoCompra->dt_emissao))}}<br>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-12 table-responsive">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="myTable">
                                    @foreach($mpedidoCompraItem as $mpedidoVI)
                                    <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>
                                            {{  'R$ '.number_format($mpedidoCompra->valorTotalsemDesconto, 2, ',', '.') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Valor desconto:</th>
                                        <td>{{  'R$ '.number_format($mpedidoCompra->valorTotalDesconto, 2, ',', '.') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Valor do pedido:</th>
                                        <td>{{  'R$ '.number_format($mpedidoCompra->valorTotalPedido, 2, ',', '.') }}
                                        </td>
                                    </tr>
                                </table>
                            </div>
