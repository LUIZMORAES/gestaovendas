        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="container">
                        <h4>Relatório de contas a pagar
                            @if(session('success'))
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <form method="post" action="{{route('Financeiro.Pagar.imprelatorioMpagar1')}}">
                                            @csrf
                                            <h3 class="card-title">Selecione o período por data de emissão
                                                <div class="row">
                                                    <div class="col-4">
