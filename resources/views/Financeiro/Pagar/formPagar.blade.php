    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="card-header">
                @if(isset($registro))
                <h3 class="card-title">Alterar conta a pagar : </h3>
                @else
                <h3 class="card-title">Incluir conta a pagar : </h3>
                @endif
                <a title="Voltar para lista de conta a pagar " href="{{ route('Financeiro.Pagar.listarMpagar') }}"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    @if(isset($registro))
                    <form method="post" action="{{route('Financeiro.Pagar.updateMpagar')}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" readonly name="id_fornecedor" class="form-control"
                                    value="{{$id_fornecedor ?? ''}}">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="cod_conta" id="codigoconta" class="form-control"
                                    value="{{ isset($cod_conta) ? $cod_conta : '2.1.01.03.02' }}" required>
                            </div>
                            <div class="col-4">
                                <label>Pedido</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="valorformaPgto1" id="precocusto" class="form-control"
                                    value="{{ isset($valorformaPgto1) ? $valorformaPgto1 : null }}" required>
                            </div>
                            <div class="col-4">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="inputGroupSelect01">Forma de pagamento
                                ...
                                <input type="text" name="valorformaPgto2" id="precovenda" class="form-control"
                                    value="{{ isset($valorformaPgto2) ? $valorformaPgto2 : null }}" required>
                            </div>
                            <div class="col-4">
                    ...
                    <form role="form" enctype="multipart/form-data" method="post"
                        action="{{route('Financeiro.Pagar.storeMpagar')}}">
                                        ...
                                        <div id="preloader">
                                            <div class="inner">
                                                ...
                                                <div class="loader">
                                                    ...
                                                    <tr>
                                                        <td>{{$mpdc->id}}</td>
                                                        <td>{{$mpdc->nomeFantasia}}
                                                        <td>{{date('d/m/Y', strtotime($mpdc->dt_emissao))}}</td>
                                                        <td>{{$mpdc->valorTotalPedido}}
                                                        </td>
                                                        <td>
                                                            <!-- Form busca pedido-->
                                                            <form method="post"
                                                                action="{{route('Financeiro.Pagar.buscarpedidoMpagar',$mpdc->id)}}">
                                                                @csrf
